...
async def finish_turn(game_id: int, game_state_repo:  GameStateRepository = Depends(), figure_card_repo:  FigureCardsRepository = Depends(), db: Session = Depends(get_db)):
    ...
    figure_card_repo.grab_figure_cards(player_id, game_id, db)
